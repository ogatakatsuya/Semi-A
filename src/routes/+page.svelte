...
<div class="header-banner flex items-center justify-between bg-gray-800 py-4 px-6 lg:px-12">
    <span class="text-white text-left text-4xl md:text-6xl lg:text-6xl lg:max-w-2/3 lg:pl-16 mb-6">次世代のプレゼン体験を<br> Presen+で</span>
	<p class="text-gray-300 text-left text-lg lg:text-xl lg:max-w-2/3 lg:pl-16 mb-6">
	...
	<section class="flex justify-center items-start text-4xl mb-12 lg:pl-16">
        <div class="flex flex-col sm:flex-row sm:justify-center lg:flex-row">
            <a href="/create" class="inline-block  bg-gray-300 px-8 py-6 text-center font-semibold text-[##2a2c41] outline-none ring-gray-300 transition duration-100 hover:bg-gray-100 focus-visible:ring active:bg-gray-200 md:text-base no-underline rounded-full" style="font-size: 24px; text-decoration: none;">今すぐ体験</a>
        </div>
    </section>
...
<div class="py-6 sm:py-8 lg:py-12 bg-[#F0F8FF] ">
	<div class="mx-auto max-w-screen-2xl px-4 md:px-8">
		...
		<h2 class="text-4xl mx-auto font-bold  lg:text-4xl">~魅力的な３つの機能~</h2>
		</div>
		...
		<div >
			...
			<a href="/about#PresenroomFeature" class="text-lg font-bold text-gray-800 text-center transition duration-100 hover:text-gray-500 lg:text-2xl break-words">パスワード制の<br>プレゼンルーム作成</a>
			</div>
		</div>
		<!-- product - end -->
